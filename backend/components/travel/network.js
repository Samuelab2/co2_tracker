...
router.post('/new', async (req, res) => { 
  try {
    const data = await controller.addTravel(req.body.start_address, req.body.end_address, req.body.transportation, req.body.km, req.body.number_workers, req.body.round_trip)
